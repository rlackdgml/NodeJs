...
const CompLast = (props) => {
  ...
  // useState(0) : 초기값을 0 으로 하는 숫자형 state 변수선언
  ...
  // state 변수를 render code에서 사용할떄
  // {변수명} 형식으로 사용한다.
  // 그런데 class 방식의 컴포넌트에서는
  //         {this.state.변수명} 형식으로 사용을 해야 한다.
  //         const {변수명} = this.state.로 비규격화하여 변수를 별도로 선언하고
  //         {변수명} 형식으로 사용해야 한다.
  return (
    <div>
      <h3>카운트 :{count}</h3>
...
// 생성된 컴포넌트를 다른 컴포넌트에서 import 하여 사용할수 있도록 선언
